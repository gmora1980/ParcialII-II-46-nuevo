<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="login.aspx.vb" Inherits="ParcialII_II_46_nuevo.login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-center mt-4">
        <a style="font-family:'Times New Roman'; font-size:x-large; color: indigo" href="Registrar.aspx">¿Primera vez que ingresa?</a>
    </div>

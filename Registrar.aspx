<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Registrar.aspx.vb" Inherits="ParcialII_II_46_nuevo.Registrar" %>
        ...
        <main class="card form-signin shadow-lg p-4 m-auto" style="max-width:300px; width:100%; border-radius: 2rem;"">
            <div class="card-body">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label style="font-family: 'Times New Roman'; font-size: large; color: black" for="MainContent_txtEmail">Correo electrónico</label>
                </div>
                <div class="form-floating mb-3">
                    <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control" TextMode="Phone" placeholder="Telefono" />
